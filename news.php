...
if( !class_exists('CC_News' ) ) {
    class CC_News {
        ...
        private static $parentSlug = 'cc-product-page';
        ...
        public function admin_news_notice() {
            ...
            $notices = get_option( 'sm_admin_notices' );
        ...
        public function add_news_page() {
            add_submenu_page ( self::$parentSlug, 'News', 'News', 'manage_options', __FILE__, array( $this, 'generate_news_page_content' ) );
        }
